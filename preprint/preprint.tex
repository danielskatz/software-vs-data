...
\affil[3]{Space Telescope Science Institute, 3700 San Martin Drive, Baltimore, Maryland, USA; arfon@stsci.edu; ORCID: 0000-0002-3957-2474}
...
\affil[11]{Institute for Medical Engineering \& Science, Massachusetts Institute of Technology, Cambridge, Massachusetts, USA; ORCID: 0000-0002-5676-7898}
...
The initial version of the text in this document was a list in an early version of \citep{SWCP}, which was developed by the FORCE11 Software Citation Working Group, which was assembled from interested volunteers who were joined by members of a WSSSPE2 working group~\citep{WSSSPE2}.  During
the review process, it became clear having it in that document was a distraction for the reviewers,
and it was separated into this repository~\citep{this-repo}, where it continued to develop.  As such,
